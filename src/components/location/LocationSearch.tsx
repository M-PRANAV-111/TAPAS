...
export function LocationSearch() {
  ...
  return <section ref={container} className="relative min-w-0 space-y-2" aria-label="Selected location">
    ...
    {open && query.trim().length >= 3 ? <div className="absolute left-0 right-0 top-[4.5rem] z-40 max-h-[min(45dvh,20rem)] overflow-y-auto rounded-lg border border-border bg-white p-1 shadow-lg">
